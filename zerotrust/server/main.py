...
def main():
    ...
    parser.add_argument("--ca-cert", type=str, default="server/ca_trust/ca_cert.json", help="CA certificate path")
    parser.add_argument("--cert", type=str, default="server/server_keys/server_cert.json", help="Server certificate JSON")
    parser.add_argument("--key", type=str, default="server/server_keys/server_private.pem", help="Server private key PEM")
    parser.add_argument("--password", type=str, default=None, help="Server private-key password")
